...
const multiCategories = [
  ...
  { id: "color", title: "全体の色合い（3個まで選択可能）", type: "colorChips", single: false, maxSelect: 3, defaultValue: "おまかせ", options: colorChipOptions, customLabel: "その他を記入", customPlaceholder: "例：白多めのマカロンカラー、夢かわ虹色、淡いピンクと水色中心" },
