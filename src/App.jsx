...
function buildPrompt({ locationType, locationOption, selected, custom, outdoorWorldId, indoorWorldId }) {
  ...
  const wallpaper = joinValues(selected, custom, "wallpaper", locationType === "indoor" ? "おまかせ（屋内世界観に合わせる）" : "");
  ...
  const isAnimalCostume = animalCostumeKeywords.some((keyword) => outfit.includes(keyword));
  const isBoardingSchoolOutfit = boardingSchoolKeywords.some((keyword) => outfit.includes(keyword));
