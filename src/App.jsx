...
const outfitTranslations = {
  ...
  "黒いロングコート": "寄宿学校や古い学院に似合う、黒い上品なロングコート。静かな映画感とクラシカルな雰囲気。",
  "黒を基調としたイギリス寄宿学校風制服": "黒を基調とした、イギリスの寄宿学校風制服。白シャツ、黒リボン、クラシカルなジャケットを合わせた中性的で上品な学院スタイル。",
  "白シャツと黒リボンの学院制服": "白シャツと黒リボンを合わせた、清潔感のあるクラシカルな学院制服。",
  "チェック柄の学院制服": "落ち着いたチェック柄を使った、クラシカルで上品な学院制服。",
  "冬の学院マント": "冬の寄宿学校や古い学院に似合う、黒や深い色のクラシカルな学院マント。",
  "赤薔薇が似合うクラシカル男子制服": "赤薔薇が似合う、黒を基調にしたクラシカルな男子制服。中性的で静かな映画感のある雰囲気。",
  "リスのきぐるみ": "リスをモチーフにした、ふわふわで可愛い小動物きぐるみ。丸い耳としっぽを可愛く表現してください。",
  "モモンガのきぐるみ": "エゾモモンガ風の、ふわふわで可愛い小動物きぐるみ。小さな耳と広がるシルエットを可愛く表現してください。",
  "ひよこのきぐるみ": "ひよこをモチーフにした、ふわふわ黄色の可愛いきぐるみ。小さなくちばし風の飾りを控えめに入れてください。",
  "うさぎのきぐるみ": "うさぎをモチーフにした、ふわふわで可愛いきぐるみ。長い耳とやさしい雰囲気を可愛く表現してください。",
  "小鳥のきぐるみ": "小鳥をモチーフにした、ふわふわで可愛いきぐるみ。小さな翼風の飾りを自然に入れてください。",
  "くまのきぐるみ": "くまをモチーフにした、ふわふわで可愛いきぐるみ。丸い耳とぬいぐるみのような雰囲気を大切にしてください。",
};

const multiCategories = [
  { id: "outfit", title: "服・衣装", icon: Shirt, options: ["なし", "夏のフリルワンピース", "ごちゃかわロリータワンピース", "お姫さまドレス", "苺柄ワンピース", "レースたっぷりワンピース", "アイドル衣装", "カフェ店員さん風エプロン", "ふわふわケープ", "ヘッドドレス付きドレス", "リボンたっぷりドレス", "クラシカルロリータ", "妖精みたいなチュールドレス", "ピンクハウス系", "ゴスロリドレス", "パンクロック衣装", "白馬の王子様衣装", "黒いロングコート", "黒を基調としたイギリス寄宿学校風制服", "白シャツと黒リボンの学院制服", "チェック柄の学院制服", "冬の学院マント", "赤薔薇が似合うクラシカル男子制服", "リスのきぐるみ", "モモンガのきぐるみ", "ひよこのきぐるみ", "うさぎのきぐるみ", "小鳥のきぐるみ", "くまのきぐるみ"] },
  ...
  { id: "wallpaper", title: "屋内の壁紙・壁飾り", indoorOnly: true, options: ["おまかせ（屋内世界観に合わせる）", "ピンクのストライプ壁紙", "苺柄の壁紙", "薔薇柄の壁紙", "小花柄の壁紙", "レース模様の壁紙", "天使やリボンの絵がある壁紙", "額縁入りの可愛い絵", "ドライフラワーの壁飾り", "リボンガーランド", "Happy Birthdayと書かれた風船のガーランド", "レースカーテン越しの光", "白い腰壁パネル", "アンティーク風の飾り棚"] },
...
function buildPrompt({ locationType, locationOption, selected, custom, outdoorWorldId, indoorWorldId }) {
  ...
  const baseScene =
    locationType === "indoor"
      ? `${buildIndoorScene({ indoorWorldId, locationOption, customLocation: custom.location })}壁や奥の空間まで可愛く作り込んでください。`
  ...
  const outfitSentence = outfit && !noOutfit ? `ペットは${outfit}を着ています。${outfitColor ? `衣装の色は${outfitColor}を基調としています。` : ""}服はペットの体型に自然に合っていて、顔や目や鼻口まわりを隠さないでください。` : "必要以上に服を追加せず、元写真の自然な魅力を尊重してください。";
...
【仕上げ】
${densitySentence}
${textOverlay !== "なし" ? `画像内に「${textOverlay}」という短い文字を、選んだ世界観・背景・服・色合いに合うフォント風デザインで、背景の邪魔にならない位置に自然に入れてください。文字が崩れる場合は、文字なしでも自然に見える構図にしてください。` : ""}
${aspectInstruction}
