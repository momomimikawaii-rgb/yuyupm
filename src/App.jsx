...
const multiCategories = [
  ...
  { id: "color", title: "全体の色合い", type: "colorChips", maxSelect: 3, defaultValue: "おまかせ", options: colorChipOptions, customPlaceholder: "例：白多めのピンク、淡い藤色、ピンク＋水色＋藤色" },
    ...
    <div className="page">
      ...
      <div className="container">
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="hero">
          ...
          <div className="update-time">最終更新：2026/05/31 05:48</div>
