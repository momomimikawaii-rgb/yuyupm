...
const multiCategories = [
  ...
  { id: "itemCategories", title: "小物カテゴリ", defaultValue: "おまかせ", maxSelect: 3, options: ["おまかせ", "なし", "布・装飾系", "スウィーツ系", "花系", "ぬいぐるみ系", "アンティーク系", "魔法学校系", "カントリー系", "パーティ系", "プリンセス・クラシカル系"], customLabel: "その他を記入", customPlaceholder: "例：和風小物、天使モチーフ、宝石系", helpText: "※選びすぎると散らかるよ💦" },
