...
const multiCategories = [
  ...
  { id: "wallpaper", title: "屋内の壁紙・壁飾り", options: ["ピンクのストライプ壁紙","苺柄の壁紙","薔薇柄の壁紙","小花柄の壁紙","レース模様の壁紙","天使やリボンの絵がある壁紙","額縁入りの可愛い絵","ドライフラワーの壁飾り","リボンガーランド","Happy Birthdayと書かれた風船のガーランド",
  "レースカーテン越しの光","白い腰壁パネル","アンティーク風の飾り棚"] },
...
${locationKind}の「${location}」で、${
  locationType === "indoor"
    ? `${items}に囲まれたペットの可愛い静止画`
    : `美しい花々や自然に囲まれたペットの可愛い静止画`
}。${containerSentence}背景には${wallpaper}を入れて、壁や奥の空間まで可愛く作り込んでください。ペットは${outfitColor}の${outfit}を着ています。服はペットの体型に自然に合っていて、顔や目や鼻口まわりを隠さないでください。色合いは${color}。光や明るさは${lighting}。雰囲気は${mood}。ペットは${pose}。背景は明るく、やさしい光に包まれていて、可愛いけれどペットの顔を邪魔しない。${brightLock}${
  locationType === "indoor"
