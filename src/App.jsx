...
function isGothicOutfitScene(locationType, indoorWorldId, locationOption) {
  return (
    locationType === "indoor" &&
    indoorWorldId === "gothicIndoor" &&
    ["吸血姫の闇かわ部屋", "悪魔姫の書斎"].includes(locationOption)
  );
}
...
function buildPrompt({ locationType, locationOption, selected, custom, outdoorWorldId, indoorWorldId }) {
  ...
  const isGothicOutfitScene = isGothicOutfitScene(locationType, indoorWorldId, locationOption);
    ...
    <div className="page">
      ...
      <div className="container">
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="hero">
          ...
          <div className="update-time">最終更新：2026/06/10（水）21:02頃</div>
