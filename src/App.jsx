...
const indoorWorlds = [
  {
    ...
    places: ["アフタヌーンティーカフェ", "お姫様の部屋", "スイーツショップ", "ドレスを着て鏡の前", "口紅をぬろうとする鏡の前", "お姫様のバスタイム", "苺スウィーツルーム", "お人形の部屋"],
  ...
  },
  {
    id: "classicAntique",
    title: "☕ クラシカル・アンティーク系",
    description: "秋色の茶色・金色・琥珀色を基調にした落ち着いたアンティーク世界。",
    places: ["アンティークカフェ", "クラシカル書斎"],
    decor: ["アンティーク家具", "ティーセット", "薔薇", "額縁", "レースカーテン", "クラシカルなランプ"],
  },
  {
    id: "idolStage",
    title: "🎀 アイドル・魔法少女",
    description: "アイドルや魔法少女が活躍するキラキラした世界。",
    places: ["アイドルステージ", "魔法少女の変身シーン", "魔法少女のお部屋"],
  ...
  },
  {
    ...
    places: ["木の上のおうち", "木の洞穴のおうち", "カントリーキッチン", "カントリールーム"],
...
const outfitTranslations = {
  ...
  "黒いロングコート": "寄宿学校や古い学院に似合う、黒い上品なロングコート。制服の上に自然に羽織るように見せ、細身で中性的な学院生風のシルエットにし、静かな映画感とクラシカルな雰囲気を大切にしてください。",
  "イギリス寄宿学校風制服": "黒を基調とした、イギリスの寄宿学校風制服。白シャツ、黒リボン、クラシカルなジャケット、上品な襟元を合わせた、細身で中性的な学院生風のスタイル。古い寄宿学校の静かな映画感が出るように、清潔感とクラシカルさを大切にしてください。",
"黒を基調としたイギリス寄宿学校風制服": "黒を基調とした、イギリスの寄宿学校風制服。白シャツ、黒リボン、クラシカルなジャケット、上品な襟元を合わせた、細身で中性的な学院生風のスタイル。古い寄宿学校の静かな映画感が出るように、清潔感とクラシカルさを大切にしてください。",
  "白シャツと黒リボンの学院制服": "白シャツと黒リボンを合わせた、清潔感のあるクラシカルな学院制服。上品な襟、控えめなジャケットやベストを合わせ、大人びすぎず幼すぎない、細身で中性的な学院生風にしてください。",
  "チェック柄の学院制服": "落ち着いたチェック柄を使った、クラシカルで上品な学院制服。派手すぎないブラウン・グレー・紺などのチェックを使い、細身で中性的な学院生風のシルエットにしてください。",
  "冬の学院マント": "冬の寄宿学校や古い学院に似合う、黒・紺・深いブラウンなどのクラシカルな学院マント。白シャツや黒リボン、制服の上に自然に羽織り、小柄〜中くらいの細身で中性的な学院生風にしてください。",
...
const clothingCategories = [
  ...
  { id: "clothingDecor", title: "服の装飾", multi: true, defaultValue: "おまかせ", options: ["おまかせ", "フリル", "レース", "リボン", "チュール", "パール", "刺繍", "ワッペン", "チェーン", "飾りジッパー", "スパンコール", "ラインストーン"] },
...
const multiCategories = [
  ...
  { id: "itemCategories", title: "小物カテゴリ", defaultValue: "おまかせ", maxSelect: 3, options: ["おまかせ", "布・装飾系", "スウィーツ系", "花系", "ぬいぐるみ系", "アンティーク系", "魔法学校系", "カントリー系", "パーティ系", "プリンセス・クラシカル系"], customLabel: "その他を記入", customPlaceholder: "例：和風小物、天使モチーフ、宝石系", helpText: "※選びすぎると散らかるよ💦" },
  { id: "fabricItems", title: "布・装飾系小物", dependsOn: { id: "itemCategories", value: "布・装飾系" }, options: ["レース", "リボン", "パール", "フリル", "チュール", "カーテン", "オーガンジーカーテン", "レース天蓋", "リボンカーテン", "テーブルランナー"], customLabel: "その他を記入", customPlaceholder: "例：白いオーガンジーカーテン、ピンクのテーブルランナー" },
  ...
  { id: "partyItems", title: "パーティ系小物", dependsOn: { id: "itemCategories", value: "パーティ系" }, options: ["風船ガーランド", "リボン付き風船", "ハートガーランド", "コンフェッティ", "ふわふわポンポン装飾", "リボンガーランド", "パールガーランド"], customLabel: "その他を記入", customPlaceholder: "例：パーティ帽子、紙飾り" },
  ...
  { id: "color", title: "全体の色合い", type: "colorChips", single: false, maxSelect: 3, defaultValue: "おまかせ", options: colorChipOptions, customLabel: "その他を記入", customPlaceholder: "例：白多めのマカロンカラー、夢かわ虹色、淡いピンクと水色中心" },
...
const COLOR_PROMPT_MAP = {
  ...
  "黒×ピンク": "黒とピンクを主役として使用した配色。背景・家具・花・リボン・レース・クッションなどにもピンクを取り入れ、黒一色にならないようにしてください。",
...
function getAutoLightingInstruction({ locationType, indoorWorldId, outdoorWorldId, locationOption, color }) {
  ...
  if (isDarkScene) {
    base.push(
      "",
      "【暗い世界観の注意事項】",
      "ゴシック・ダークメルヘン・夜景・月明かりの雰囲気は残しつつ、ペットの顔・目・鼻口まわり・毛並みは暗くしすぎないでください。",
...
function translateColor(color) {
  ...
  const translations = {
    ...
    "黒×ピンク":
      "黒とピンクを主役として使用した配色。背景・家具・花・リボン・レース・クッションなどにもピンクを取り入れ、黒一色にならないようにしてください。",
    "黒×紫":
      "黒を基調に紫をアクセントとして使用した配色",
    "白×金":
...
function getDreamLolitaMirrorScenePrompt(locationOption) {
  ...
  if (locationOption === "口紅をぬろうとする鏡の前") {
    return "鏡・ドレッサー・口紅・コスメが見える専用構図を優先してください。可能であれば鏡の中にもペットの顔を自然に映してください。不自然な場合は反射を無理に作らないでください。";
  }
  return "";
}
function buildIndoorScene({ indoorWorldId, locationOption, customLocation }) {
  ...
  const gothicPlaceDescriptions = {
    ...
    "悪魔姫の書斎":
      "桔梗紫色と銀を基調にした悪魔姫の書斎。大きな本棚、古書、魔導書、紫薔薇、銀色の花、桔梗紫色の花、銀細工、青紫のランプがある。ペットは紫宝石の銀ティアラ、カラスの羽のように艶やかに照り光る桔梗紫色の翼を身につけ、アンティークな椅子やソファで開いた古書を読んでいる。",
    "悪役令嬢のパーティルーム":
  ...
  const dreamLolitaPlaceDescriptions = {
    ...
    "お姫様のバスタイム":
      "優雅なお姫様のバスルーム。白いアンティーク猫足バスタブの泡風呂で、ペットは湯船の中で体を伸ばし、浴槽の内側にもたれかかって全身の力を抜いています。後頭部は浴槽の縁に軽く触れて支えられており、背中は浴槽の内側に自然に預けています。ペットは浴槽の中央ではなく奥側の内壁にもたれかかっています。体は浴槽の長い方向に沿ってまっすぐ伸ばしています。顔を浴槽の中央に配置せず、奥側の縁に近い位置にしてください。温かいお風呂で眠くなり、気持ちよさそうにうとうと居眠りしています。体はお湯と泡の中に沈み、顔だけが泡の上に自然に見えています。首・胸・肩・前足は泡の中に隠してください。前足は浴槽の縁に乗せず、浴槽を掴ませないでください。ペットはカメラ目線にせず、モデル撮影のようなポーズも取らせないでください。顔の見える部分は、バスタブ全体の幅の4分の1を超えない小さめのバランスにしてください。ただし小さすぎて表情が分からないほどにはしないでください。ペットを大きく写しすぎず、白いアンティーク猫足バスタブ全体と猫足の脚まで見える、少し引き気味の構図。バスタブの横にはふわふわのバスマット。しっぽは無理に見せず、元写真の向きや体勢的に自然な場合のみ、泡の外に少し見えてもよいです。レースカーテンのある窓辺からやわらかな光が差し込み、花柄の壁紙、上品なアンティーク家具、白い猫足の小さなバスワゴン、豪華なクリスタルボトルに入ったシャンプーとリンス、香水瓶が見える、夢かわいく清潔感のあるバスタイム空間。",
    "苺スウィーツルーム":
...
function buildPrompt({ locationType, locationOption, selected, custom, outdoorWorldId, indoorWorldId }) {
  ...
  const clothingSentence = noClothes
    ...
    : clothingParts.length
      ...
      : isVillainessPartyScene
        ...
        : locationType === "indoor" && indoorWorldId === "gothicIndoor" && locationOption === "闇かわアイドルステージ"
          ? "服は黒とピンクを基調にした闇かわアイドル風ゴスロリ衣装を自然に着せてください。フリル、リボン、ハート、レースを使い、ライブアイドルらしい可愛く華やかな雰囲気にしてください。ぬいぐるみやおもちゃ箱の世界観に合う、少しメルヘン寄りのデザインにしてください。ペットの体型に自然に合っていて、顔・目・鼻口まわりを隠さないでください。"
        : locationType === "indoor" && indoorWorldId === "gothicIndoor" && locationOption === "吸血姫の闇かわ部屋"
          ? "服は赤黒を基調にした赤い薔薇付きのゴスロリドレスを自然に着せてください。上品で闇かわいい吸血姫の雰囲気にしてください。ペットの体型に自然に合っていて、顔・目・鼻口まわりを隠さないでください。"
  ...
  const itemSentence = isBathScene
    ? items
      ...
      : "小物は必要な場合のみ、バスタオル、黄色のひよこのおもちゃ、薔薇の花びら、豪華なクリスタルボトルに入ったシャンプーとリンスを控えめに追加してください。スリッパは追加しないでください。"
    : items
            ...
            {multiCategories
              .map((category) => isBathScene && category.id === "items"
                ? {
                    ...category,
                    title: "バスタイム小物",
                    options: ["おまかせ", "なし", "バスタオル", "黄色のひよこのおもちゃ", "薔薇の花びら", "豪華なクリスタルボトルに入ったシャンプー", "豪華なクリスタルボトルに入ったリンス"],
